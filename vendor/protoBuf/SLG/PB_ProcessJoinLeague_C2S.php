...
namespace {
/**
 * PB_ProcessJoinLeague_C2S message
 */
class PB_ProcessJoinLeague_C2S extends \ProtobufMessage
{
    /* Field index constants */
    const ID = 1;
    const LEAGUE_ID = 2;
    const APPLICANT_ID = 3;
    const TYPE = 4;
    ...
    public function reset()
    {
        ...
        $this->values[self::APPLICANT_ID] = null;
    ...
    /**
     * Sets value of 'applicant_id' property
     *
     * @param integer $value Property value
     *
     * @return null
    ...
    {
        return $this->set(self::APPLICANT_ID, $value);
    }

    /**
     * Returns value of 'applicant_id' property
     *
     * @return integer
     */
    public function getApplicantId()
    {
        $value = $this->get(self::APPLICANT_ID);
        return $value === null ? (integer)$value : $value;
    }
