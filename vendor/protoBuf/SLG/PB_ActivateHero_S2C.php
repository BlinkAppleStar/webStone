...
namespace {
/**
 * PB_ActivateHero_S2C message
 */
class PB_ActivateHero_S2C extends \ProtobufMessage
{
    ...
    public function reset()
    {
        ...
        $this->values[self::ACTIVE_HERO] = null;
    ...
    /**
     * Sets value of 'active_hero' property
     *
     * @param \PB_Hero $value Property value
     *
     * @return null
     */
    public function setActiveHero(\PB_Hero $value=null)
    {
        return $this->set(self::ACTIVE_HERO, $value);
    }

    /**
     * Returns value of 'active_hero' property
     *
     * @return \PB_Hero
     */
    public function getActiveHero()
    {
        return $this->get(self::ACTIVE_HERO);
    }
